...
namespace KingdomMod {
    public class ConfigStrings {
        ...
        public static void ConfigBind(ConfigFile config) {
            ...
            DogSpawn = config.Bind("Strings", "DogSpawn", "Dog", "");
            ...
            HermitBaker = config.Bind("Strings", "HermitBaker", "Baker", "");
            HermitBallista = config.Bind("Strings", "HermitBallista", "Ballista", "");
            HermitHorn = config.Bind("Strings", "HermitHorn", "Horn", "");
            HermitHorse = config.Bind("Strings", "HermitHorse", "Stable", "");
            HermitKnight = config.Bind("Strings", "HermitKnight", "Knight", "");
            Hooded = config.Bind("Strings", "Hooded", "Hooded", "");
            HorseBurst = config.Bind("Strings", "HorseBurst", "Burst", "");
            HorseFast = config.Bind("Strings", "HorseFast", "Fast", "");
            HorseStamina = config.Bind("Strings", "HorseStamina", "Stamina", "");
            ...
            StatueArcher = config.Bind("Strings", "StatueArcher", "Archer", "");
            StatueFarmer = config.Bind("Strings", "StatueFarmer", "Farmer", "");
            StatueKnight = config.Bind("Strings", "StatueKnight", "Knight", "");
            StatueTime = config.Bind("Strings", "StatueTime", "Time", "");
            StatueWorker = config.Bind("Strings", "StatueWorker", "Worker", "");
        ...
        private static void OnConfigFileChanged(object source, FileSystemEventArgs e) {
            try {
                LogUtil.Message($"OnConfigFileChanged: {e.Name}, {e.ChangeType}");
